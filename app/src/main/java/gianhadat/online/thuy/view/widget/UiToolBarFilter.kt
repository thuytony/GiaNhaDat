...
import kotlinx.android.synthetic.main.ui_toolbar_filter.view.*

/**
 * Created by thuythu on 12/03/2018.
 */
class UiToolBarFilter: RelativeLayout, BaseView{
    ...
    override fun init(attrs: AttributeSet, defStyleAttr: Int) {
        ...
        v = LayoutInflater.from(context).inflate(R.layout.ui_toolbar_filter,this,true)
        ...
        context.let {
            ...
            v.icFilter.setOnClickListener { SimpleToast.showShort("click filter") }
        }
